...
import com.dev2qa.constant.CostantVariable;
import com.dev2qa.model.Employee;
import com.dev2qa.repository.EmployeeRepository;
...
public class EmployeeController {
    ...
    public String listEmployeeList(Model model) {
        ...
        model.addAttribute(CostantVariable.EMPLOYEE_LIST, employeeList);
